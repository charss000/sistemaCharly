...
export const Sidebar = () => {
  ...
  const [showSubmenu,setShowSubmenu]=useState(false);
    return (
        <div className="xl:h-[100vh] overflow-y-scroll fixed xl:static w-[80%] md:w-[40%] lg:w-[30%] xl:w-auto h-full top-0 bg-secondary-300  flex flex-col justify-between z-0  p-4 text-gray-300">
            <div>
